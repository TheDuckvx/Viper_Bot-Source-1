...
async def automaticRestart(ctx: disnake.Message):
    try:
        ...
        __embed__ = disnake.Embed(title="AutoMatic-Restart! (Every 12 Hours!)",
                                  description="We Do AutoMatic Restarts Every 12 Hours To Make Sure Our System Always Works!",
        ...
        __errorEmbed0__ = disnake.Embed(title="AutoMatic-Restart (Critic-Error)",
                                        description="This Error Means That Our Bot Did Not Restart But Do Not Worry The Bot Will Still Continue To Work While Our Developer(s) Figure Out The Error.",
                                        color=disnake.Color.random()) \
            .set_thumbnail(
            url="https://th.bing.com/th/id/OIP.hPCNCgkK0whctJSE1zifNQHaEo?w=248&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7"
        ) \
...
async def changeStatus():
    await client.change_presence(status=disnake.Status.dnd,
                                 activity=disnake.Game(name="on " + str(len(client.guilds)) + " Servers.", type=0))
...
async def kick(ctx: disnake.Message, __member__: disnake.Member, *, __reason__=None):
    try:
        if __reason__ is None:
            try:
                __memberEmbed__ = disnake.Embed(title="Kicked",
            ...
            if __reason__ is not None:
                try:
                    __embed__ = disnake.Embed(title=f"{__member__}",
                                              description=f"You Have Been Kicked From: {ctx.guild}, For: {__reason__}\n||  ||Make Sure You Read Our Rule(s)!") \
                        .set_thumbnail(
                        url='https://th.bing.com/th/id/OIP.COYEZS1SJ4znwY6931asnAAAAA?pid=ImgDet&rs=1'
                    )
                    ...
                    __new0__ = disnake.Embed(title=f"{__member__}",
                                             description=f"Successfully Kicked: {__member__} For: {__reason__}",
                                             color=disnake.Color.random()) \
                        .set_thumbnail(url='https://th.bing.com/th/id/OIP.COYEZS1SJ4znwY6931asnAAAAA?pid=ImgDet&rs=1') \
                        .set_footer(icon_url="https://th.bing.com/th/id/OIP.COYEZS1SJ4znwY6931asnAAAAA?pid=ImgDet&rs=1",
                                    text="𝓑𝔂 𝓥𝓟𝓢-𝓢𝓮𝓻𝓿𝓮𝓻 | 𝓒𝓸𝓭𝓲𝓷𝓰 - 𝓣𝓮𝓪𝓶")
                    await ctx.channel.send(
                        embed=__new0__
                    )
...
async def ban(ctx: disnake.Message, __member__: disnake.Member, *, __reason__=None):
    try:
        if __reason__ is None:
            try:
                __memberEmbed__ = disnake.Embed(title="Banned",
                                                description=f"You Have Been Banned From: {ctx.guild} For: {__reason__}\n||  ||Please Make Sure You Read The Rule(s)",
                                                color=disnake.Color.red()) \
                    .set_thumbnail(
...
async def purge(ctx: disnake.Message, __amount__: int):
    try:
        __embed__ = disnake.Embed(title="Purged!", description=f"Successfully Purged: {__amount__} Messages!",
                                  color=disnake.Color.random()) \
            .set_thumbnail(
            url="https://th.bing.com/th/id/OIP.hPCNCgkK0whctJSE1zifNQHaEo?w=248&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7"
        ) \
...
async def invite(ctx: disnake.Message):
    try:
        __embed__ = disnake.Embed(title="Invite!",
                                  description="Invite Me To Your Server With Administrator Perm's For Best Exsperience!",
                                  url="https://discord.com/api/oauth2/authorize?client_id=1040469651865485324&permissions=8&scope=bot",
                                  color=disnake.Color.random()) \
            .set_thumbnail(
            url="https://th.bing.com/th/id/OIP.hPCNCgkK0whctJSE1zifNQHaEo?w=248&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7"
        ) \
...
async def add_role(ctx: disnake.Message, __member__: disnake.Member, *, __role__: disnake.Role):
    try:
        ...
        __embed__ = disnake.Embed(title=f"{__member__}", description=f"Successfully Gave: {__role__} To: {__member__}",
                                  color=disnake.Color.random()) \
            .set_thumbnail(
            url='https://th.bing.com/th/id/OIP.hPCNCgkK0whctJSE1zifNQHaEo?w=248&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7'
        )
...
async def remove_role(ctx: disnake.Message, __member__: disnake.Member, *, __role__: disnake.Role):
    try:
        ...
        __embed__ = disnake.Embed(title=f"{__member__}",
                                  description=f"Successfully Removed: {__role__} From: {__member__}") \
            .set_thumbnail(
            url="https://th.bing.com/th/id/OIP.hPCNCgkK0whctJSE1zifNQHaEo?w=248&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7"
        )
        await ctx.channel.send(embed=__embed__)
...
async def get_anouncements(ctx: disnake.Message):
    try:
        ...
        __embed__ = disnake.Embed(title="Anouncement(s)", description=f"Online_Anouncement(s): {__getURL__.content}",
                                  color=disnake.Color.random())
        __embed__.set_thumbnail(
            url='https://th.bing.com/th/id/OIP.hPCNCgkK0whctJSE1zifNQHaEo?w=248&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7')
...
async def updates(ctx: disnake.Message):
    try:
        __embed__ = disnake.Embed(title="Checking..", description="Checking For Update(s)..",
                                  color=disnake.Color.random()) \
            .set_thumbnail(
            url="https://th.bing.com/th/id/OIP.hPCNCgkK0whctJSE1zifNQHaEo?w=248&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7"
        ) \
        ...
        if __rURL__.content.decode() != __rURL0__.content.decode():
            __embed0__ = disnake.Embed(title="Update Available!", description="There Is A New Update!",
                                       color=disnake.Color.random()) \
                .set_thumbnail(
                url="https://th.bing.com/th/id/OIP.hPCNCgkK0whctJSE1zifNQHaEo?w=248&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7"
            )
...
async def source(ctx: disnake.Message):
    try:
        __embed__ = disnake.Embed(title="Source Code", description="Our Main Source Code For This Bot!",
                                  url='https://github.com/DeepSleepMusic/Viper_Bot-Source',
                                  color=disnake.Color.random()) \
            .set_thumbnail(
            url='https://th.bing.com/th/id/OIP.hPCNCgkK0whctJSE1zifNQHaEo?w=248&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7'
        ) \
...
async def report(ctx: disnake.Message, __member__: disnake.Member, *, __report__: str):
    try:
        __embed0__ = disnake.Embed(title=f"{__member__}",
                                   description=f"The Member: {__member__} Has Been Reported For: {__report__}",
                                   color=disnake.Color.random()) \
            .set_thumbnail(
            url="https://th.bing.com/th/id/OIP.hPCNCgkK0whctJSE1zifNQHaEo?w=248&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7"
        )
        await client.get_channel(1040853061763084299).send(embed=__embed0__)
        __embed__ = disnake.Embed(title=f"{__member__} Reported!",
                                  description=f"The Following Member: {__member__.mention} Has Been Reported For: {__report__}",
                                  color=disnake.Color.random()) \
            .set_thumbnail(
            url="https://th.bing.com/th/id/OIP.hPCNCgkK0whctJSE1zifNQHaEo?w=248&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7") \
            .set_footer(
...
async def warn(ctx: disnake.Message, member: disnake.Member, *, __warn__: str):
    try:
        _embed_ = disnake.Embed(title=f"{member}",
                                description=f"The Member: {member.mention} Has Been Warned For: {__warn__}",
                                color=disnake.Color.random()) \
            .set_thumbnail(
            url="https://th.bing.com/th/id/OIP.hPCNCgkK0whctJSE1zifNQHaEo?w=248&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7"
        ) \
